...
import MyTechnicalAnalysis from "../Components/TradingviewGraphic/WidgetTechnicalAnalysis ";
          ...
          <div className="wallet-item pb-4">
            ...
            <div className="d-flex">
              <img
                ...
                className="wd-30 ht-30 ml-3 my-auto"
                alt="coin image"
              />
              <div className="ms-3">
                <p className="text-uppercase text-gray mb-0">Available BTC</p>
                <div className="d-flex my-auto">
                  <h2 className="mt-1 mb-0">0.0</h2>
                  <span className="mt-auto mb-1 ms-2">BTC</span>
                </div>
              </div>
            </div>
    ...
    c7.204,0,13.972-2.8,19.028-7.856l177.54-177.552C453.164,296.104,453.164,279.028,442.668,268.536z"
            ...
            <div className="qrcode-item mt-4 mb-4">
              <img
                ...
                alt="qr code"
              />
              <h4 className="text-center text-primary fs-12 mt-4">
        ...
        <center>
          <MyTechnicalAnalysis symbol="BITSTAMP:BTCUSD"></MyTechnicalAnalysis>
        </center>
      </main>
