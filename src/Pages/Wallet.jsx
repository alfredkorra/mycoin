...
function Wallet(){
    ...
    <div className="d-flex my-auto"><h2 className="mt-1 mb-0">0.0</h2><span
    ...
    <img src={image ? image  : "/qr-code.png"} onChange={(e) => setImage(e.target.value)} alt="qr code"/>
    ...
    <button onClick={copyAdd} className="btn btn-primary clipboard-icon clipboard-box"
